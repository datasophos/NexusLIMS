...
specified in the :ref:`NX_INSTRUMENT_DATA_PATH <nexuslims-instrument-data-path>` environment variable),
...
directory contained in the :ref:`NX_DATA_PATH <nexuslims-data-path>` environment
variable that matches where the original raw
data file was found in the directory from the
:ref:`NX_INSTRUMENT_DATA_PATH <nexuslims-instrument-data-path>` environment variable. A link to
